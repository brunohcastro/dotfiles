return {
	{
      ...
      local mappings = {
        ...
        { "<leader>e",   "<cmd>lua Snacks.explorer()<CR>",                                                        desc = "Toggle Explorer",          remap = false },
        ...
        { "<leader>pi",  "<cmd>Lazy install<CR>",                                                                 desc = "Install",                  remap = false },
        { "<leader>pl",  "<cmd>Lazy home<CR>",                                                                    desc = "Home",                     remap = false },
        { "<leader>ps",  "<cmd>Lazy sync<CR>",                                                                    desc = "Sync",                     remap = false },
        { "<leader>pu",  "<cmd>Lazy update<CR>",                                                                  desc = "Update",                   remap = false },

...
import XMonad.Hooks.ManageDocks (docks, avoidStruts, checkDock, manageDocks)
import XMonad.Hooks.ManageHelpers (isFullscreen, doFullFloat, doLower)
import XMonad.Hooks.EwmhDesktops (ewmhFullscreen, ewmh, fullscreenEventHook)
